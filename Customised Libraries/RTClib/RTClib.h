...
public:
    ...
    static void writeSqwPinMode(Ds3231SqwPinMode mode);
	 void enableRTC_DS3231Interrupts(bool enabled);
	 void enableRTCAlarm(bool alarm_1, bool alarm_2);
	 bool clearRTCAlarm1(bool clearAlarm = false);
	 bool clearRTCAlarm2(bool clearAlarm = false);
	 void setAlarm1Time(const DateTime& dt, bool dayOfWeek = false);
	 void setAlarm1Time(uint8_t second, uint8_t minute, uint8_t hour, uint8_t day, bool dayOfWeek = false);
	 void setAlarm2Time(uint8_t minute, uint8_t hour, uint8_t day, bool dayOfWeek = false);
