 ...
 */
#define STRING_PRODUCT "Arduino Zero SAMD21J18A "
#define USB_VID_HIGH   0x23
#define USB_VID_LOW    0x9A
#define USB_PID_HIGH   0x00
#define USB_PID_LOW    0xDD
...
#define BOARD_LEDRX_PORT                  (1) //port A is 0, port B is 1
#define BOARD_LEDRX_PIN                   (0) // this the hardware port pin number e.g. PB00 =  port 1 pin 0 here
